define([
  ...
  return declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    postCreate: function() {
      ...
      this.s.classList.add("redstatus");
      ...
      on(
        ...
        lang.hitch(this, function() {
          ...
          if (this.classNum.value > 10) {
            this.s.innerHTML = "Status: Maximum number of classes reached - 10";
    ...
    startup: function() {
      ...
      if (window.open == true) {
        ...
        //this sets this widgets date attributes with the global var values
        this.begday = window.begday;
        this.begyear = window.begyear;
        this.endmonth = window.endmonth;
        this.endday = window.endday;
        this.endyear = window.endyear;
        ...
        this.begindatepicker.value = window.begindatepicker;
        this.enddatepicker.value = window.enddatepicker;
    ...
    onOpen: function() {
      ...
      this.s.innerHTML = "Status: SelectTrans widget opened";
    },
    ...
    loadFilters: function(results) {
      ...
      if (resultCount > 0) {
        ...
        alert("No filters for this user");
        this.s.innerHTML = "Status: No filters found for this user.!";
        theoption.text = "none";
    ...
    deleteFilter: function(results) {
      // function alertRed() {
      //   this.s.style.AnimationPlayState = "running";
      // }
      var resultCount = results.features.length;
      //alert(resultCount);
      ...
      } else this.s.innerHTML = "Status: Please select a filter to delete";
      //alertRed() needs work; 9/3/2019
      //alertRed();
    },
    ...
    updateCustomFilter: function() {
      ...
      //window.begindatepicker =  this.begindatepicker.value;
      //window.enddatepicker = this.enddatepicker.value;
    ...
    updateChkBx: function() {
      this.descripTextf.value = window.descripText;
      /*
                this.tmcsrcChkBx.checked =  featureAttributes["SRCTMC"];
                this.tompsrcChkBx.checked =  featureAttributes["SRCTOMP"];
                this.deatrsrcChkBx.checked =  featureAttributes["SRCDEATR"];	
                this.udengsrcChkBx.checked =  featureAttributes["SRCUDENG"];
                this.trfcntsrcChkBx.checked =  featureAttributes["SRCTRFCT"];
                this.tdfmsrcChkBx.checked =  featureAttributes["SRCTDFM"];
                this.studysrcChkBx.checked =  featureAttributes["SRCSTUD"];
                this.toothsrcChkBx.checked =  featureAttributes["SRCBLUE"];
                this.fhasrcChkBx.checked =  featureAttributes["SRCFHA"];
                this.probeChkBx.checked =  featureAttributes["SRCPROBE"];
                */
      this.monChkBx.checked = window.monChkBx;
      this.tuesChkBx.checked = window.tuesChkBx;
      this.wedChkBx.checked = window.wedChkBx;
      this.thurChkBx.checked = window.thurChkBx;
      this.friChkBx.checked = window.friChkBx;
      this.satChkBx.checked = window.satChkBx;
      this.sunChkBx.checked = window.sunChkBx;
      this.wkdayChkBx.checked = window.wkdayChkBx;
      this.wkendChkBx.checked = window.wkendChkBx;
      this.janChkBx.checked = window.janChkBx;
      this.febChkBx.checked = window.febChkBx;
      this.marChkBx.checked = window.marChkBx;
      this.aprChkBx.checked = window.aprChkBx;
      this.mayChkBx.checked = window.mayChkBx;
      this.junChkBx.checked = window.junChkBx;
      this.julChkBx.checked = window.julChkBx;
      this.augChkBx.checked = window.augChkBx;
      this.sepChkBx.checked = window.sepChkBx;
      this.octChkBx.checked = window.octChkBx;
      this.novChkBx.checked = window.novChkBx;
      this.decChkBx.checked = window.decChkBx;
      this.h1ChkBx.checked = window.h1ChkBx;
      this.h2ChkBx.checked = window.h2ChkBx;
      this.h3ChkBx.checked = window.h3ChkBx;
      this.h4ChkBx.checked = window.h4ChkBx;
      this.h5ChkBx.checked = window.h5ChkBx;
      this.h6ChkBx.checked = window.h6ChkBx;
      this.h7ChkBx.checked = window.h7ChkBx;
      this.h8ChkBx.checked = window.h8ChkBx;
      this.h9ChkBx.checked = window.h9ChkBx;
      this.h10ChkBx.checked = window.h10ChkBx;
      this.h11ChkBx.checked = window.h11ChkBx;
      this.h12ChkBx.checked = window.h12ChkBx;
      this.h13ChkBx.checked = window.h13ChkBx;
      this.h14ChkBx.checked = window.h14ChkBx;
      this.h15ChkBx.checked = window.h15ChkBx;
      this.h16ChkBx.checked = window.h16ChkBx;
      this.h17ChkBx.checked = window.h17ChkBx;
      this.h18ChkBx.checked = window.h18ChkBx;
      this.h19ChkBx.checked = window.h19ChkBx;
      this.h20ChkBx.checked = window.h20ChkBx;
      this.h21ChkBx.checked = window.h21ChkBx;
      this.h22ChkBx.checked = window.h22ChkBx;
      this.h23ChkBx.checked = window.h23ChkBx;
      this.begday = window.begday;
      this.begyear = window.begyear;
      this.endmonth = window.endmonth;
      this.endday = window.endday;
      this.endyear = window.endyear;
      this.int0ChkBx.checked = window.int0ChkBx;
      this.int5ChkBx.checked = window.int5ChkBx;
      this.int15ChkBx.checked = window.int15ChkBx;
      this.hrintChkBx.checked = window.hrintChkBx;
      this.dayintChkBx.checked = window.dayintChkBx;
      this.aggtypeDropList.value = window.aggtypeDropList;
      this.byvar1DropList.value = window.byvar1DropList;
      this.byvar2DropList.value = window.byvar2DropList;
      this.begindatepicker.value = window.begindatepicker;
      this.enddatepicker.value = window.enddatepicker;
      this.allyrChkBx.checked = window.allyrChkBx;
      this.schChkBx.checked = window.schChkBx;
      this.sumChkBx.checked = window.sumChkBx;
      this.frstChkBx.checked = window.frstChkBx;
      this.secChkBx.checked = window.secChkBx;
      this.thrdChkBx.checked = window.thrdChkBx;
      this.frthChkBx.checked = window.frthChkBx;
      this.alldayChkBx.checked = window.alldayChkBx;
      this.ampkChkBx.checked = window.ampkChkBx;
      this.midChkBx.checked = window.midChkBx;
      this.pmpkChkBx.checked = window.pmpkChkBx;
      //this.min0ChkBx.checked =  featureAttributes["MIN0"];
      //this.min15ChkBx.checked =  featureAttributes["MIN15"];
      //this.min30ChkBx.checked =  featureAttributes["MIN30"];
      //this.min45ChkBx.checked =  featureAttributes["MIN45"];
      this.yr2008ChkBx.checked = window.yr2008ChkBx;
      this.yr2009ChkBx.checked = window.yr2009ChkBx;
      this.yr2010ChkBx.checked = window.yr2010ChkBx;
      this.yr2011ChkBx.checked = window.yr2011ChkBx;
      this.yr2012ChkBx.checked = window.yr2012ChkBx;
      this.yr2013ChkBx.checked = window.yr2013ChkBx;
      this.yr2014ChkBx.checked = window.yr2014ChkBx;
      this.yr2015ChkBx.checked = window.yr2015ChkBx;
      this.yr2016ChkBx.checked = window.yr2016ChkBx;
      this.yr2017ChkBx.checked = window.yr2017ChkBx;
      this.descripTextf.value = window.descripText;
      //add src
      this.sourceDropList.value = window.srcvalue;
    },
    ...
    loadFilterDataf: function(results) {
      ...
      window.begday = featureAttributes["BEGDAY"];
      window.begyear = featureAttributes["BEGYEAR"];
      window.endmonth = featureAttributes["ENDMONTH"];
      window.endday = featureAttributes["ENDDAY"];
      window.endyear = featureAttributes["ENDYEAR"];
      ...
      window.begindatepicker = featureAttributes["BEGDATE"];
      this.begindatepicker.value = featureAttributes["BEGDATE"];
      window.enddatepicker = featureAttributes["ENDDATE"];
      ...
      this.begday = featureAttributes["BEGDAY"];
      this.begyear = featureAttributes["BEGYEAR"];
      this.endmonth = featureAttributes["ENDMONTH"];
      this.endday = featureAttributes["ENDDAY"];
      this.endyear = featureAttributes["ENDYEAR"];
    ...
    loadFilterData: function(results) {
      ...
      if (typeof sqlExpression === "undefined") {
        this.s.innerHTML =
          "Status: No matching SQL Expression found! Please select another source.";
        return 0;
      }
      ...
      console.log("should be going to vol now");
    },
    ...
    saveFilt: function() {
      ...
      if (this.TheUserf.value != "none") {
        ...
        if (this.CurrentFilterf.value == "" && this.TheUserf.value == "") {
          this.s.innerHTML =
            "Status: Please select a username and filter name before saving";
          return 0;
        } else if (this.CurrentFilterf.value == "") {
          this.s.innerHTML =
            "Status: Please select a filter name before saving";
          return 0;
        } else if (this.sourceDropList.value == "none") {
          this.s.innerHTML =
            "Status: Please select a data source before saving";
          return 0;
        }
        var attr = {
          USERNAME: this.TheUserf.value,
    ...
    vol: function(results) {
      ...
      this.s.innerHTML = "Status: Packaging data for query...";
      console.log("should be in vol now");
      console.log(results.features.length);
      if (results.features.length < 1) {
        this.s.innerHTML =
          "Status: No data was found in " + window.currentfilter;
        return 0;
      }
      window.avgvolarr = [];
      window.lrsidarr = [];
    ...
    queryATT: function(results) {
      this.s.innerHTML = "Status: Sending database query...";
      ...
      //increments count for when we want to paint another layer on the map
      //window.count++;
      console.log("results");
    ...
    saveRT: function() {
      if (this.TheUser.value != "none") {
        ...
        alert("Route selection has been saved to user: " + this.TheUser.value);
      } else if (this.TheUser.value == "none") {
        alert("Please input a username before saving a route selection");
      } else if (
        this.trafficSQL.value == "" ||
